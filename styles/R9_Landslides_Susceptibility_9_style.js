var size = 0;
var placement = 'point';
function categories_R9_Landslides_Susceptibility_9(feature, value, size, resolution, labelText,
                       labelFont, labelFill, bufferColor, bufferWidth,
                       placement) {
                switch(value.toString()) {case 'DF':
...
case 'ML':
                    return [ new ol.style.Style({
        stroke: new ol.style.Stroke({color: 'rgba(35,35,35,1.0)', lineDash: null, lineCap: 'butt', lineJoin: 'miter', width: 0.988}),fill: new ol.style.Fill({color: 'rgba(166,217,106,1.0)'}),
        text: createTextStyle(feature, resolution, labelText, labelFont,
                              labelFill, placement, bufferColor,
                              bufferWidth)
    })];
...
var style_R9_Landslides_Susceptibility_9 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    var value = feature.get("LndslideSu");
    var labelText = "";
    size = 0;
...
var style = categories_R9_Landslides_Susceptibility_9(feature, value, size, resolution, labelText,
